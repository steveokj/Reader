                ...
                return (
                  <article key={selection.id} className="data-card">
                    <div className="data-card__meta">
                      ...
                      <span>{new Date(selection.created_at).toLocaleString()}</span>
                    </div>
                ...
                return (
                  <article key={addition.id} className="data-card">
                    <div className="data-card__meta">
                      ...
                      <span>{new Date(addition.created_at).toLocaleString()}</span>
                    </div>
                    <div className="data-card__title">
                ...
                return (
                  <article key={item.marker.id} className="data-card">
                    <div className="data-card__meta">
                      ...
                      <span>{new Date(item.marker.created_at).toLocaleString()}</span>
                    </div>

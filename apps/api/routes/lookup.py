...
DEFAULT_FULL_PAGE_SELECTOR = ".redesign-container"
...
WAIT_MS_ENV = os.getenv("LOOKUP_SNAPSHOT_WAIT_MS")
WAIT_MS = int(WAIT_MS_ENV) if WAIT_MS_ENV and WAIT_MS_ENV.strip() else 800
